...
<div class="mtui-picker">\
    <div class="mtui-picker__hd">\
        <a href="javascript:;" data-action="cancel" class="mtui-picker__action">取消</a>\
        <a href="javascript:;" data-action="select" class="mtui-picker__action" id="mtui-picker-confirm">确定</a>\
    </div>\
    <% if(!!search){ %>\
    <div class="mtui-picker__searchBox">\
        <input class="mtui-picker__search" type="text" placeholder="<%= searchPlaceholder %>" />\
    </div>\
    <% } %>\
    <div class="mtui-picker__bd"></div>\
</div>\
</div>';
const groupTpl = '<div class="mtui-picker__group">\
<div class="mtui-picker__mask"></div>\
<div class="mtui-picker__indicator"></div>\
<div class="mtui-picker__content"></div>\
</div>';
