...
export default {
  ...
  methods: {
    ...
    setHandler() {
      const distance =
        Math.round(this.distance / this.stepWidth) * this.stepWidth;
    ...
    init() {
      this.sliderLength = parseInt(
        this.$refs.inner.getBoundingClientRect().width,
        10
      );
