...
<template>
  <div class="box">
    <div
      :class="['container', hasTransition ? 'transition' : '']"
      ref="box"
    ...
    >
      ...
      <div
        class="bottom"
        :style="{ backgroundColor: bottomBg, color: bottomColor }"
        v-else
        @click="loadMoreBottom"
      >
        <slot name="bottom">
          <div
            v-if="bottomStatus == 'loading'"
            class="flex-center column tipss"
          >
            <img
              src="../../assets/svg/bars.svg"
              style="width: .44rem;"
